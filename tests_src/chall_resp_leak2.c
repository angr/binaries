...
int main() {
  puts("Hello this is a test program where you solve a challenge response then get a flag leak");
  puts("this tests the ability to quickly filter the 'fake' leak");
  real_main();
  return 0;
}
