...
void int_to_str2(int num, int base, char *dst) {
...
char *passes[] = {"secret_pass1", "skj3292>><>", "#12344", "abc", "Z", "TTTTTTTTTTT", "thelongsecretpass", "t23921", "1337", "zz"};
...
int play_game() {
    ...
    receive_until2(0, ans, '\n', 30);
    if (strcmp(ans, passes[choice]))
      return 0;
    return 1;
}
...
void real_main() {
  char buf[0x100];
  if (play_game()) {
   // send_all(1, "you answered: ", strlen("you answered: "));
   // send_all(1, &ans, 4);
   // send_all(1, "\n", 1);
